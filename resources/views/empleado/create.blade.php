			...
			<div class="panel-body">
				<form class="form-horizontal" action="{{ url('empleado') }}" method="post" enctype="multipart/form-data">
					...
					<fieldset>
						...
						<!-- Imagen input-->
						<div class="form-group">
							<label class="col-md-3 control-label" for="imagen">Imagen agregada</label>
							<div class="col-md-9">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input value="{{ old('nomImagen') }}" id="nomImagen" name="nomImagen" type="text" placeholder="Nombre de la imagen" class="form-control"/>
								@error('nomImagen')
						            <div class="alert alert-danger">{{ $message }}</div>
						        @enderror
							</div>
...
<!--@section('js')-->
    <!-- nuevo 4 -->
<!--    <script src="{{ url('assets/js/disable.js') }}"></script>-->
    <!-- nuevo 4 -->
<!--@endsection-->