			...
			<div class="panel-body">
				<form class="form-horizontal" action="{{ url('empleado/'.$empleado->id) }}" method="post">
					...
					<fieldset>
						...
						@if(isset($imagen->tipoImagen))
						<!-- Imagen input-->
						<div class="form-group">
							<label class="col-md-3 control-label" for="idempleadojefe">Imagen guardada</label>
							<div class="col-md-9">
						            <img src="{{ 'https://informatica.ieszaidinvergeles.org:10032/laraveles/empleadosApp/storage/app/public/imagenes/'.$empleado->id.'/default.'.$imagen->tipoImagen }}" alt="">
							</div>
						</div>
						@endif
						...
						<!-- Nombre input-->
						<div class="form-group">
							<label class="col-md-3 control-label" for="nomImagen">Nombre de la imagen</label>
							<div class="col-md-9">
								<input value="{{ old('nomImagen', $imagen->nomImagen) }}" id="nomImagen" name="nomImagen" type="text" placeholder="Nombre de la imagen" class="form-control"/>
								@error('nomImagen')
						            <div class="alert alert-danger">{{ $message }}</div>
						        @enderror
							</div>
