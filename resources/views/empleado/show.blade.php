				...
				<table class="table table-hover">
					<thead>
			            <tr>
			                ...
			                @if($imagen->tipoImagen!=null)
			                <th class="table-light" scope="col">imagen</th>
			                @endif
			                
			                @if($imagen->nomImagen!=null)
			                <th class="table-light" scope="col">nombre de imagen</th>
			                @endif
			                <th></th>
			            </tr>
			        </thead>
			        <tbody>
			                <tr>
			                    ...
			                    @if($imagen->tipoImagen!=null)
			                    <td><img width="150px" height="150px" src="{{ 'https://informatica.ieszaidinvergeles.org:10032/laraveles/empleadosApp/storage/app/public/imagenes/'.$empleado->id.'/default.'.$imagen->tipoImagen }}" alt=""></td>
			                    @endif
			                    
			                    
			                	@if($imagen->nomImagen!=null)
			                    <td>{{$imagen->nomImagen}}</td>
			                    @endif
